          ...
          <CardContent className="p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                >
                  <div className="shrink-0 w-12 h-12 rounded-full bg-brand-blue/10 flex items-center justify-center group-hover:bg-brand-blue/20 transition-colors">
                ...
                >
                  <div className="shrink-0 w-12 h-12 rounded-full bg-brand-blue/10 flex items-center justify-center group-hover:bg-brand-blue/20 transition-colors">
                    <SiInstagram className="text-brand-blue" size={24} />
                  </div>
                  <div>
              ...
              {/* CTA Section */}
              <div className="flex flex-col justify-center space-y-6 bg-gradient-to-br from-brand-blue/5 to-brand-navy/5 p-8 rounded-lg">
                <div>
                  <h3 className="text-2xl font-semibold mb-4">Ready to Grow?</h3>
