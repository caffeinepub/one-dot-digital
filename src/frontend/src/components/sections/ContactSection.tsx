...
export default function ContactSection() {
  ...
  return (
    <SectionShell id="contact" className="bg-background relative">
      ...
      >
        <div
          className="absolute -top-14 -left-20 w-64 h-44 rounded-[70px] opacity-[0.06] rotate-[-15deg]"
          style={{ background: "oklch(var(--primary))", filter: "blur(40px)" }}
        />
        <div
          className="absolute -bottom-10 -right-16 w-72 h-52 rounded-[60px] opacity-[0.06] rotate-[12deg]"
          style={{ background: "oklch(var(--primary))", filter: "blur(40px)" }}
        />
      </div>
      <div
        ...
        <Card className="overflow-hidden bg-card border-border shadow-sm">
          <CardContent className="p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* CTA Section */}
              <div className="flex flex-col justify-center space-y-6 bg-gradient-to-br from-primary/5 to-secondary p-8 rounded-lg border border-primary/20 relative overflow-hidden">
                {/* Abstract digital marketing image as decorative bg */}
                <div
                  className="absolute inset-0 rounded-lg overflow-hidden pointer-events-none"
                  aria-hidden="true"
                >
                  <img
                    src="/assets/generated/digital-marketing-abstract.dim_900x500.jpg"
                    alt=""
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-6">
                    Let's discuss how we can help transform your business into a
                    digital powerhouse. Reach out today and let's get started.
                  </p>
                </div>
