...
export default function AboutSection() {
  ...
  return (
    <SectionShell id="about" className="bg-secondary/50">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-primary">Who Are We?</h2>
        </div>
        ...
        >
          {values.map((value, index) => (
            <div
              key={value.title}
              className="text-center p-6 rounded-lg bg-white border border-border hover:border-primary/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 hover:scale-105"
